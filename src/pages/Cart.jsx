      ...
      {count.length === 0 ? <h1>No items here</h1> : count.map(data => (
        ...
        <div className="product_in_cart" key={count.indexOf(data)}>
          ...
          <div className='product_column'>
            ...
            {/* <button className='remove_item_button' onClick={() => dispatch(remove_one_from_cart(data))}>Remove one item</button> */}

            <div className='counter'>
              <button className='remove_item_button' onClick={() => dispatch(add_to_cart(data))}>+</button>
                <span>{data.count}</span>
              <button className='remove_item_button' onClick={() => dispatch(remove_one_from_cart(data))}>-</button>
            </div>
