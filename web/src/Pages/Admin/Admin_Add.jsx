...
const Admin_Add = () => {
    ...
    const send_to_backend = (event) => {
        ...
        const response_promise = axios.post(
            process.env.API_URL + '/admin/add',
            formData,
            {
                headers: {
    ...
    const get_text_to_pic_array = (prev, pic_name, e) => {
        if (prev !== null && prev.product_text) {
            const text_found = prev.product_text.find(
                (obj) => obj.pic === pic_name
            )
            if (text_found) {
                ...
                return [
                    ...prev.product_text,
                    { pic: pic_name, text: e.target.value },
                ]
            }
        } else {
    ...
    return (
        <Column>
            ...
            <Form
                ...
                className="__form column"
            >
                <label>Title</label>
                <Text
                    id="name"
                    placeholder="name"
                    onChange={(e) => add_to_state(e)}
                />
