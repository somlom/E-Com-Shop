...
export const Product = () => {
    ...
    const { id } = useParams()
    const { isLoading, isError, data, isSuccess } = useGetData(
        '/products/' + id
    )
    ...
    const add_to_cart_state = () => {
        dispatch(set_to_cart({ id: data._id }))
        toast.success(t('successfuly_added'))
    }
        ...
        return (
            <>
                <Column className="">
                    ...
                    <Column className="product_body">
                        ...
                        {data.product_text.map((obj) => {
                            return (
                                <Row
                                    className="product_text_element"
                                    key={obj._id}
                                >
                                    <img
                                        src={
                ...
                <Row className="buy_row">
                    ...
                    <Link to={'/pay_for_item/' + id} className="primary_button">
                        {t('buy_now')}
                    </Link>
                    <a className="primary_button" onClick={add_to_cart_state}>
                        {t('add')}
                    </a>
                </Row>
            </>
